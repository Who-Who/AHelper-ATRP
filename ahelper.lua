...
function event.onServerMessage(color, text)
	--[[AUTOUPDATE-WAITER]]if text:find('^Вы вошли как .+') then autoupdate('https://raw.githubusercontent.com/Who-Who/AHelper-ATRP/main/currentver') end
