...
function fastoi(param)
	if #param ~= 0 and param:find('^%d+') then
		sampSendChat('/mute '..param:match('^(%d+)')..' 30 оскорбление игроков')
	else
