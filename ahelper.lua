...
function main()
	...
	sampRegisterChatCommand('acommands', commands)
...
function imgui.OnDrawFrame()
	if imgbase.v then
		...
		imgui.Begin('AHelper: '..img, imgbase)
		if img == 'info' then
			imgui.Text(u8'/ahelper - список возможностей хелпера (без команд)')
			imgui.Text(u8'/acommands - список остальных возможностей хелпера')
		...
		elseif img == 'fast fcoins' then
			...
			imgui.Text(u8'Что же этот модуль делает? Удивительно! Быстро прокачивает видеокарту/суперкомпьютер/сервер. Команды:')
...
function info()
	sampShowDialog(666, 'AHelper: список возможностей', '{'..acolor1..'}Информация\n{'..acolor5..'}Выдача мута\n{'..acolor5..'}Ответ на репорт\n{'..acolor5..'}Быстрые ники\n{'..acolor5..'}Список друзей\n{'..acolor5..'}Удаление спама', 'Выбрать', 'Закрыть', 2)
end
function commands()
	sampShowDialog(777, 'AHelper: список команд', '{'..acolor1..'}Информация\n{'..acolor5..'}/msgk\n{'..acolor5..'}/msg1\n{'..acolor5..'}/msg2\n{'..acolor5..'}/msg3\n{'..acolor5..'}/msg4\n{'..acolor5..'}/msg5\n{'..acolor5..'}/cmd1\n{'..acolor5..'}/cmd2\n{'..acolor5..'}/cmd3\n{'..acolor5..'}/getip\n{'..acolor5..'}/fcoins >> 2\n{'..acolor5..'}/iznas\n{'..acolor5..'}/sms\n{'..acolor5..'}/otbor', 'Выбрать', 'Закрыть', 2)
end
function dialog()
	while true do
		wait(0)
		...
		if result then if button == 1 then
			...
			elseif list == 12 then img = 'iznas'
			elseif list == 13 then img = 'asms'
			elseif list == 14 then img = 'otbor'
			else img = 'info'
			end
		end end
